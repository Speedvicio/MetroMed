...
Module Preload
    ...
    Public Sub LoadResource()
        ...
        MetroMed.mMednafen.Image = (New Bitmap(MedExtra & "Resource\Gui\setting.png"))
        ...
        MetroMed.mImport.Image = (New Bitmap(MedExtra & "Resource\Gui\palette.png"))
        MetroMed.BoxartToolStripMenuItem.Image = (New Bitmap(MedExtra & "Resource\Gui\add.png"))
        MetroMed.SnapMovieToolStripMenuItem.Image = (New Bitmap(MedExtra & "Resource\Gui\mrecord.png"))
